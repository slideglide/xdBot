  ...
  private:
    ...
    bool init() override {
        ...
        intervalInput->setString(
            Mod::get()->getSavedValue<std::string>("autosave_interval").c_str());
        ...
        CCMenuItemSpriteExtra* btn =
            CCMenuItemSpriteExtra::create(btnSpr, this, menu_selector(AutoSaveLayer::onClose));
    ...
    void updateInputs() {
        ...
        intervalInput->getInputNode()->m_textLabel->setOpacity(g.autosaveIntervalEnabled ? 255
                                                                                         : 100);
